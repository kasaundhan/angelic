                        ...
                        <li>
                          ...
                          <li >
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ url('customer/addressbook') }}">Address book</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="{{ url ('/metals') }}"><i class="fa fa-dashboard fa-fw"></i>Metals</a>
                        </li>
                        <li>
                            <a href="{{ url ('/ringsize') }}"><i class="fa fa-dashboard fa-fw"></i>Ring Size</a>
                        </li>
                        <li>
                            <a href="{{ url ('/status') }}"><i class="fa fa-dashboard fa-fw"></i>Status</a>
                        </li>
                        <li>
                            <a href="{{ url ('/delivery') }}"><i class="fa fa-dashboard fa-fw"></i>Delivery Methods</a>
                        </li>
                        <li>
                            <a href="{{ url ('/payment') }}"><i class="fa fa-dashboard fa-fw"></i>Payment Methods</a>
                        </li>
                        <li>
                            <a href="{{ url ('/logout') }}"><i class="fa fa-edit fa-fw"></i>Logout</a>
                        </li>
                        <li>
